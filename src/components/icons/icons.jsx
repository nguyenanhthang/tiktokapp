...
export const HomeGroupIcon = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <>
            <svg
                className={className}
...
export const UserActiveIcon = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <>
            <svg
                className={className}
...
export const LiveGroupIcon = ({ width = '3rem', height = '3rem', className }) => {
    return (
        <>
            <svg
                className={className}
